...
export default function CreateOnlineTestLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="flex items-start justify-center p-6 pt-10">
        <div className="w-full max-w-7xl shadow-2xl border-0 rounded-xl overflow-hidden bg-white">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-t-xl px-8 py-5">
            <div className="h-7 w-48 bg-white/20 rounded animate-pulse" />
            <div className="h-4 w-72 bg-white/10 rounded mt-2 animate-pulse" />
          </div>
          <FormSkeleton />
        </div>
      </div>
