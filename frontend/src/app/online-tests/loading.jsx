...
export default function OnlineTestsLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="flex items-start justify-center p-6 pt-10">
        <div className="w-full max-w-7xl shadow-2xl border-0 rounded-xl overflow-hidden bg-white">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-t-xl px-8 py-5 flex justify-between items-center">
            <div>
          ...
          <div className="p-4 border-b border-gray-100 bg-white">
             <div className="h-10 max-w-md bg-gray-100 rounded-md animate-pulse" />
          </div>
