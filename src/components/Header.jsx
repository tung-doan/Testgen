...
const { user,setUser, loading } = useAuth(); // Access the user state from the context
    ...
    <header className="w-full bg-[#dfdfdf] py-6 position-sticky top-0 z-50 shadow-md">
      <div className="container max-w-[1152px] mx-auto flex justify-between items-center cursor-pointer">
        ...
        {user ? (
          ...
          <Button className="bg-[#00d636] p-2 text-black hover:bg-[#212221] hover:text-[#00BE06] [font-family:'Inter-Regular',Helvetica] text-2xl h-[49px] rounded-lg cursor-pointer transition-colors duration-300 ease-in-out" onClick={() => {
            handlerlogout()
          }}>
            Logout
          </Button>
